...
WEIGHTS_EQUIPMENT_PERSON_POSE='weights/equipment/1127/yolo11m-pose.pt'
WEIGHTS_EQUIPMENT_PERSON_DETECT='weights/equipment/1127/yolo11n.pt'
WEIGHTS_EQUIPMENT_WARNING_ZONE_DETECT='weights/equipment/1127/equipment_warning_zone_1127.pt'
WEIGHTS_EQUIPMENT_SEAT_PLATE_DETECT='weights/equipment/1127/equipment_seat_plate_1127.pt'

WEIGHTS_EQUIPMENT=[
    WEIGHTS_EQUIPMENT_SAFETY_BELT_DETECT,
    WEIGHTS_EQUIPMENT_PERSON_POSE,
    WEIGHTS_EQUIPMENT_PERSON_DETECT,
    WEIGHTS_EQUIPMENT_SEAT_PLATE_DETECT,  
    WEIGHTS_EQUIPMENT_WARNING_ZONE_DETECT
...
#吊具警戒区域顶部视角
EQUIPMENT_WARNING_ZONE_REGION_TOP = np.array([
[[668, 375], [750, 0], [1670, 0], [1666, 529]],
], np.int32)

#吊具警戒区域正部视角
EQUIPMENT_WARNING_ZONE_REGION_FORNT = np.array([
[[1084, 992], [1084, 1440], [1620, 1440], [1620, 992]],
], np.int32)

#吊具挂点装置 正面视角
EQUIPMENT_ANCHOR_DEVICE_REGION = np.array([
[[545, 0], [545, 1440], [1628, 1440], [1628, 0]],
], np.int32)
